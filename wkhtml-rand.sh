...
wkhps="$hd/wkhtmltox/bin/wkhtmltoimage";
...
grabpdf-wkh () {
	...
	tt=`date +%Y-%m-%d.%H:%M:%S`;
	timeout 140  "$wkh" --javascript-delay 5000 -d 300 -L 0mm -R 0mm -T 0mm -B 0mm --page-width 9in --page-height "$3in"   "$1" "$direct/$2-wkh.pdf";
